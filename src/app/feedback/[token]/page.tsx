...
export default function FeedbackPage({
  ...
  return (
    <main className="flex min-h-screen items-center justify-center bg-slate-50 px-4 py-10">
      <section className="w-full max-w-md rounded-xl border border-slate-200/70 bg-white p-8">
        <div className="mb-6">
          ...
          <form className="space-y-5" onSubmit={submit}>
            ...
            <label className="block">
              ...
              <textarea
                ...
                rows={4}
                className="mt-2 w-full rounded-lg border border-slate-200/70 bg-white px-3 py-2 text-sm text-slate-900 outline-none transition focus:border-green-500 focus:ring-2 focus:ring-green-100"
