        ...
        {ACTIONS.map(a => {
          ...
          return (
            <Link
              key={a.href}
              href={a.href}
              className={`flex flex-col items-center justify-center gap-2 rounded-xl border border-slate-200/70 bg-white px-3 py-4 text-sm font-medium text-slate-700 transition-colors ${a.hoverClass}`}
            >
              <span
