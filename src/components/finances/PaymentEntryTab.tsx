...
type Props = {
  ...
  prefillLead?: LeadHit;
  // Fires after a successful save so a parent (e.g. RecordPaymentModal)
  // can dismiss itself or refresh a list view.
  onSaved?: () => void;
};
...
export default function PaymentEntryTab({ prefillLead, onSaved }: Props = {}) {
    ...
    <div className="grid gap-4 lg:grid-cols-3">
      ...
      <div className="space-y-5 lg:col-span-2">
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
          <h2 className="text-sm font-semibold tracking-tight text-slate-900">Patient</h2>
                  ...
                  {leadHits.slice(0, 4).map(h => (
                    ...
                    >
                      ...
                      <button
                        type="button"
                        onClick={() => linkLead(h)}
                        className="inline-flex items-center gap-1 rounded-lg bg-indigo-600 px-3.5 py-2 text-sm font-semibold text-white shadow-sm transition-colors hover:bg-indigo-700"
                      >
                        <Link2 size={12} />
                        Link
                      </button>
        ...
        <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
          <div className="flex items-center justify-between gap-2">
            <h2 className="text-sm font-semibold tracking-tight text-slate-900">Charges</h2>
          ...
          <div className="mt-3 flex flex-wrap items-end gap-2 border-t border-slate-100 pt-3">
            ...
            <label className="block">
              ...
              <input
                ...
                inputMode="numeric"
                placeholder="0"
                className="mt-1 w-28 rounded-lg border border-slate-200 bg-white px-3.5 py-2 text-sm text-slate-900 shadow-sm outline-none transition focus:border-indigo-500 focus:ring-2 focus:ring-indigo-100"
              />
            </label>
            <button
              type="button"
              ...
              className="inline-flex items-center gap-1 rounded-lg border border-slate-200 bg-white px-3.5 py-2 text-sm font-medium text-slate-700 shadow-sm transition-colors hover:bg-slate-50 hover:text-slate-900 disabled:opacity-60"
            >
              <UserPlus size={12} />
              Add line
            </button>
      ...
      <aside className="space-y-5 lg:col-span-1">
        <section className="rounded-2xl border border-slate-200 bg-white p-5 shadow-sm">
          <h2 className="text-sm font-semibold tracking-tight text-slate-900">Total</h2>
        ...
        <button
          type="button"
          onClick={reset}
          className="w-full rounded-lg border border-slate-200 bg-white px-4 py-2 text-sm font-medium text-slate-700 shadow-sm transition-colors hover:bg-slate-50 hover:text-slate-900"
        >
